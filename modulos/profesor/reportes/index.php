     ...
     <div class="row">
        <div class="col-lg-6 col-xs-12 col-sm-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="../../reportes/profesores.php" class="small-box-footer">Descargar                    <i class="fa fa-file-pdf-o"></i></a>
          </div>
        </div>
        <!-- ./col -->
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="../../reportes/estudiantes.php" class="small-box-footer">Descargar                    <i class="fa fa-file-pdf-o"></i></a>
          </div>
        </div>
        <!-- ./col -->
          ...
          <div class="small-box bg-green">
            ...
            <div class="icon">
              <i class="fa fa-downloadion ion-archive"></i>
            </div>
            <a href="../../reportes/materias.php" class="small-box-footer">Descargar                    <i class="fa fa-file-pdf-o"></i></a>
          </div>
        </div>
        <!-- ./col -->
          ...
          <div class="small-box bg-purple">
            ...
            <a href="../../reportes/notas.php" class="small-box-footer">Descargar                    <i class="fa fa-file-pdf-o"></i></a>
          </div>
        </div>
        <!-- ./col -->
