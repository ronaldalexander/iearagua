...
<head>
  ...
  <title>Profesor | Panel de Control</title>
      ...
      <div class="row">
        <div class="col-lg-12 col-xs-6 col-sm-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="notas/" class="small-box-footer">Ver más <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="reportes/" class="small-box-footer">Ver más <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
