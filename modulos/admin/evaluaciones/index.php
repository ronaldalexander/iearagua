...
?>
    ...
    <head>
        ...
        <title>Administrador | Evaluaciones </title>
        ...
        Administrador
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div align="center" class="box-header with-border">
                            <h1 class="box-title">Evaluaciones</h1> </div>
                        <!-- /.box-header -->
                        <div class="col-md-12">
                                        ...
                                        <div class="modal-body" align="center">
                                            <form role="form" method="post" action="">
                                                <div class="form-group has-feedback">
                                                    <input type="text" class="form-control" name="evaluacion" placeholder="Evaluaciones" required> <span class="glyphicon glyphicon-edit form-control-feedback"></span> </div>
                                                <button type="submit" class="btn btn-default"><span class="ion ion-plus"></span> </button>
                                            </form>
                                            <?php if(!empty($_POST['evaluacion'])){
    
            $evaluacion = $_POST['evaluacion'];
    
            $sql = "INSERT INTO evaluaciones(nombre_evaluacion) values ('$evaluacion')";
        	...
        	if($result!=null){
				...
				print "<script>alert(\"No se pudo agregar.\");window.location='index.php';</script>";
                   ...
                   $pa=$mysqli->query("SELECT * FROM evaluaciones WHERE id_evaluacion LIKE '%$buscar%' OR nombre_evaluacion LIKE '%$buscar%'");	
				  ...
				  ?>
                                        <tr>
                                            <td>
                                                <?php echo $row['id_evaluacion']; ?>
                                            </td>
                                            <td>
                                                <?php echo $row['nombre_evaluacion']; ?>
                                            </td>
                                            <td> <a class='btn btn-danger' href='elimina.php?id=<?php echo $row[' id_evaluacion ']; ?>'><i class="ion ion-trash-a"></i></a> </td>
                                        </tr>
                                        <?php }}else{
                              
                    
                   $pa=$mysqli->query("SELECT * FROM evaluaciones");	
