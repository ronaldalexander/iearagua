...
?>
    ...
    <head>
        ...
        <title>Administrador | Grados</title>
        ...
        Administrador
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div align="center" class="box-header with-border">
                            <h1 class="box-title">Grados</h1> </div>
                        <!-- /.box-header -->
                        <div class="col-md-12">
                                        ...
                                        <div class="modal-body" align="center">
                                            <form role="form" method="post" action="">
                                                <div class="form-group has-feedback">
                                                    <input type="text" class="form-control" name="grado" placeholder="Grado" required> <span class="glyphicon glyphicon-edit form-control-feedback"></span> </div>
                                                <button type="submit" class="btn btn-default"><span class="ion ion-plus"></span> </button>
                                            </form>
                                            <?php if(!empty($_POST['grado'])){
    
            $grado = $_POST['grado'];
    
            $sql = "INSERT INTO grados(nombre_grado) values ('$grado')";
        	...
        	if($result!=null){
				...
				print "<script>alert(\"No se pudo agregar.\");window.location='index.php';</script>";
                   ...
                   $pa=$mysqli->query("SELECT * FROM grados WHERE id_grado LIKE '%$buscar%' OR nombre_grado LIKE '%$buscar%'");	
				  ...
				  ?>
                                        <tr>
                                            ...
                                            <td> <a class='btn btn-danger' href='elimina.php?id=<?php echo $row[' id_grado ']; ?>'><i class="ion ion-trash-a"></i></a> </td>
                                        </tr>
                                        <?php }}else{
                              
                    
                   $pa=$mysqli->query("SELECT * FROM grados");	
