...
<head>
  ...
  <title>Administrador | Secciones</title>
      ...
      <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div align="center" class="box-header with-border">
              <h1 class="box-title">Secciones</h1>
            </div>
            <!-- /.box-header -->
...
<form role="form" method="post" action="">
  ...
  <button type="submit" class="btn btn-default"><span class="ion ion-plus"></span>
</button>
</form>
       
       <?php if(!empty($_POST['seccion'])){
    
            $seccion = $_POST['seccion'];
    
            $sql = "INSERT INTO secciones(nombre_seccion) values ('$seccion')";
            ...
            <div class="box-body">
              <table id="example1" class="text-center table table-bordered table-striped">
                ...
                <?php 
                   ...
                   $pa=$mysqli->query("SELECT * FROM secciones WHERE id_seccion LIKE '%$buscar%' OR nombre_seccion LIKE '%$buscar%'");	
				  ...
				  ?>
                                      ...
                                      <td>
                                        ...
                                        <td>
                                          ...
                                          <td>
                                                     ...
                                                     <a class='btn btn-danger' href='elimina.php?id=<?php echo $row['id_seccion']; ?>'><i class="ion ion-trash-a"></i></a>
                   ...
                   $pa=$mysqli->query("SELECT * FROM secciones");	
