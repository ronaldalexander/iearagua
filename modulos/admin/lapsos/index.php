...
?>
    ...
    <head>
        ...
        <title>Administrador | Lapsos </title>
        ...
        Administrador
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div align="center" class="box-header with-border">
                            <h1 class="box-title">Lapsos</h1> </div>
                        <!-- /.box-header -->
                        <div class="col-md-12">
                                        ...
                                        <div class="modal-body" align="center">
                                            <form role="form" method="post" action="">
                                                <div class="form-group has-feedback">
                                                    <input type="text" class="form-control" name="lapso" placeholder="Lapsos" required> <span class="glyphicon glyphicon-edit form-control-feedback"></span> </div>
                                                <button type="submit" class="btn btn-default"><span class="ion ion-plus"></span> </button>
                                            </form>
                                            <?php if(!empty($_POST['lapso'])){
    
            $lapso = $_POST['lapso'];
    
            $sql = "INSERT INTO lapsos(nombre_lapso) values ('$lapso')";
        	...
        	if($result!=null){
				...
				print "<script>alert(\"No se pudo agregar.\");window.location='index.php';</script>";
                   ...
                   $pa=$mysqli->query("SELECT * FROM lapsos WHERE id_lapso LIKE '%$buscar%' OR nombre_lapso LIKE '%$buscar%'");	
				  ...
				  ?>
                                        <tr>
                                            <td>
                                                <?php echo $row['id_lapso']; ?>
                                            </td>
                                            <td>
                                                <?php echo $row['nombre_lapso']; ?>
                                            </td>
                                            <td> <a class='btn btn-danger' href='elimina.php?id=<?php echo $row[' id_lapso ']; ?>'><i class="ion ion-trash-a"></i></a> </td>
                                        </tr>
                                        <?php }}else{
                              
                    
                   $pa=$mysqli->query("SELECT * FROM lapsos");	
