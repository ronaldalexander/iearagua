      ...
      <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div align="center" class="box-header with-border">
              <h1 class="box-title">Profesores</h1>
            </div>
            <!-- /.box-header -->
...
<form role="form" method="post" action="">
  ...
  <div class="form-group has-feedback">
    ...
    <input type="text" class="form-control" name="numero_celular" placeholder="Teléfono" required>
    <span class="glyphicon glyphicon-edit form-control-feedback"></span>
  </div>
  ...
  <button type="submit" name="enviar" class="btn btn-default"><span class="ion ion-plus"></span>
       ...
       <?php if(!empty($_POST['cedula']) and !empty($_POST['nombre'])){
            ...
            $clave = $_POST['clave'];
            $tipo = $_POST['tipo'];
            $institucion_id_institucion = "1";
    
    
            $sql = "INSERT INTO usuarios(cedula, primer_nombre, segundo_nombre, genero, email, fecha_nacimiento, numero_celular, usuario, clave, institucion_id_institucion, tipo_usuario) values ('$cedula', '$nombres', '$apellidos', '$genero', '$email', '$fecha_nacimiento', '$numero_celular', '$usuario', '$clave', '$institucion_id_institucion', '$tipo')";
            ...
            <div class="box-body">
              <table id="example1" class="text-center table table-bordered table-striped">
                ...
                <?php 
                   ...
                   $pa=$mysqli->query("SELECT * FROM usuarios WHERE cedula LIKE '%$buscar%' OR primer_nombre LIKE '%$buscar%' OR segundo_nombre LIKE '%$buscar%' OR genero LIKE '%$buscar%'");	
...
<!-- Button trigger modal -->
  ...
  <a data-toggle="modal" href="#myModal<?php echo $row['id_usuario']; ?>" class="btn btn-warning"><i class="ion ion-edit"></i></a>
   <!-- Modal -->
  <div class="modal fade" id="myModal<?php echo $row['id_usuario']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<form role="form" method="post" action="edita.php" class="form-horizontal">
  ...
  <label for="cedula" class="col-sm-2 control-label">Cédula</label>
   ...
   <div class="col-sm-10">
    <input type="text" class="form-control" name="cedula" id="cedula" value="<?php echo $row['cedula']; ?>"  readonly>
    </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
    <input type="text" class="form-control" name="nombre" id="nombres" value="<?php echo $row['primer_nombre']; ?>" required></div>
  ...
  <div class="form-group">
      ...
      <div class="col-sm-10">
    <input type="text" class="form-control" name="apellido" id="apellidos" value="<?php echo $row['segundo_nombre']; ?>" required></div>
  ...
  <label for="genero" class="col-sm-2 control-label">Género</label>
   <div class="col-sm-10">
    <input type="text" class="form-control" name="genero" value="<?php echo $row['genero']; ?>" required></div>
  ...
  <label for="genero" class="col-sm-2 control-label">Email</label>
   <div class="col-sm-10">
    <input type="email" class="form-control" name="email" id="email" value="<?php echo $row['email']; ?>" required></div>
   ...
   <div class="form-group">
    ...
    <div class="col-sm-10">
    <input type="date" class="form-control" name="fecha_nacimiento" id="fecha_nacimiento" value="<?php echo $row['fecha_nacimiento']; ?>" required></div>
  ...
  <label for="numero_celular" class="col-sm-2 control-label">Teléfono</label>
   <div class="col-sm-10">
    <input type="text" class="form-control" name="numero_celular" id="numero_celular" value="<?php echo $row['numero_celular']; ?>" required></div>
  ...
  <div class="form-group">
      ...
      <div class="col-sm-10">
    <input type="text" class="form-control" name="usuario" id="usuario" value="<?php echo $row['usuario']; ?>" required></div>
  ...
  <div class="form-group">
      ...
      <div class="col-sm-10">
    <input type="text" class="form-control" name="clave" id="clave" value="<?php echo $row['clave']; ?>" required></div>
  ...
  <button type="submit" name="enviar" class="btn btn-default"><span class="ion ion-edit"></span>
                                                    ...
                                                    <td>
                                                     ...
                                                     <a class='btn btn-danger' href='elimina.php?id=<?php echo $row['id_usuario']; ?>'><i class="ion ion-trash-a"></i></a>
                   ...
                   $pa=$mysqli->query("SELECT * FROM usuarios");	
