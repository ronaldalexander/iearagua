            ...
            <aside class="main-sidebar">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <li class="treeview active">
                            <a href="index.php"> <i class="ion ion-android-create"></i> <span> Materias</span> <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span> </a>
                        </li>
                        <li class="treeview">
        ...
        Administrador
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div align="center" class="box-header with-border">
                            <h1 class="box-title">Materias</h1> </div>
                        <!-- /.box-header -->
                        <div class="col-md-12">
                                        ...
                                        <div class="modal-body" align="center">
                                            <form role="form" method="post" action="">
                                                <div class="form-group has-feedback">
                                                    <input type="text" class="form-control" name="materia" placeholder="Materia" required> <span class="glyphicon glyphicon-edit form-control-feedback"></span> </div>
                                                <button type="submit" class="btn btn-default"><span class="ion ion-plus"></span> </button>
                                            </form>
                                            <?php if(!empty($_POST['materia'])){
    
            $materia = $_POST['materia'];
    
            $sql = "INSERT INTO materias(nombre_materia) values ('$materia')";
        	...
        	if($result!=null){
				...
				print "<script>alert(\"No se pudo agregar.\");window.location='index.php';</script>";
                   ...
                   $pa=$mysqli->query("SELECT * FROM materias WHERE id_materia LIKE '%$buscar%' OR nombre_materia LIKE '%$buscar%'");	
				  ...
				  ?>
                                        <tr>
                                            ...
                                            <td> <a class='btn btn-danger' href='elimina.php?id=<?php echo $row[' id_materia ']; ?>'><i class="ion ion-trash-a"></i></a> </td>
                                        </tr>
                                        <?php }}else{
                              
                    
                   $pa=$mysqli->query("SELECT * FROM materias");	
